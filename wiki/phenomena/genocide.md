...
Genocide is operationalized legally (the Convention's intent-plus-target-group test), demographically (death tolls, survival rates by group), and typologically (efforts to separate "genocide proper" from adjacent categories). Definitions disagree at the margins — over whether political groups count, over the threshold of "in part," and over the role of intent — and these disagreements are themselves contested terrain.

## Patterns and Findings (attributed)

Bauman's theorization (attributed voice; a contested framework, not a wiki-voice finding — see [[holocaust-and-modernity-debate]]):

- **Modern vs. pre-modern genocide.** "Ordinary" genocide aims to destroy a group *as a viable community* (terror to force surrender, "beheading" of its elites) and neither seeks nor obtains the victims' co-operation. **Modern** genocide is different: "genocide with a purpose," an element of *social engineering* — rationally planned, bureaucratically executed, low in spontaneity, with only a marginal role for mobilized mass hatred.
- **The Holocaust's peculiarity.** Because the Nazi aim was total *Entfernung* rather than subjugation, the Holocaust — unlike ordinary genocide — *preserved* the victims' communal structure (the Judenräte) in order to harness their administration and their [[social-production-of-distance|rationality of self-preservation]]. → detail in [[bauman-modernity-holocaust-1989]] (Ch. 5).
...
See [[holocaust-and-modernity-debate]] (the modernity thesis and its critics); the intentionalist-vs-functionalist historiographical dispute over the Holocaust's decision-making is noted there and on the source page. Bauman's 2000 "hereditary victimhood" argument — that claimed descent from victims can be mobilized to legitimate new violence — is politically charged and recorded strictly in attributed voice.
