---
title: "Sexual Division of Labor"
concept_type: "analytical"
coined_by: ["(long-standing); theorized in forager context at [[lee-devore-man-the-hunter-1968|Man the Hunter]] (1968)"]
date_coined: "long-standing; foraging-specific accounts 1968"
disciplines: ["cultural-anthropology", "biological-anthropology"]
emic_or_etic: "etic"
...
The allocation of tasks by sex. Among hunter-gatherers it is conventionally described as
**men hunt, women gather** — but the *[[lee-devore-man-the-hunter-1968|Man the Hunter]]*
volume (1968) is where two things were established together: that the division is near-universal
among foragers, and that the *gathering* side (women's work) usually supplies the caloric
majority of the diet, inverting the older hunting-centred image.

## Semantic History

The volume records a shift and a fault line. **The shift:** Meggitt criticized earlier
ethnography (e.g. Basedow) for giving male hunting "more than five times the space" of women's
gathering, "whereas... women's contribution to the daily diet is usually far greater";
[[lee-what-hunters-do-study|Lee]] found !Kung women "provide two to three times as much food
by weight as the men." **The fault line:** competing *causal* accounts of why the division
exists (below), including the androcentric [[hunting-hypothesis|"Man the Hunter" thesis]] that
later became the target of the "Woman the Gatherer" critique (see
[[man-the-hunter-woman-the-gatherer-debate]]).

## Operationalizations

*(Findings, dated to each study.)*
- **!Kung** (Lee): vegetable foods 60–80% of diet by weight, gathered by women; men and women
  put in roughly equal work-time but women supplied 2–3× the food by weight.
- **Hadza** (Woodburn): ~80% of food by weight vegetable (women's/children's daily gathering);
  hunting exclusively male, individual, unpredictable.
- **Australia** (Meggitt, Yengoyan): "the diet of the Australian aborigine is basically
  vegetarian," gathered by women.
- **Cross-cultural** (Murdock, Whiting, Ethnographic Atlas): "a strikingly uniform division of
  labor" — women gather; men hunt; where societies fish, men manage the more complex
  techniques.

## Applications

The concept is load-bearing for the [[original-affluent-society|affluent-society]] argument
...
Two rival causal accounts sit unreconciled in the volume. **Washburn & Lancaster** derived
the division from **big-game hunting** organization — male cooperation in the hunt
"intensif[ying]" sex-role differentiation, reinforced by primate play-behaviour differences —
part of the strongly biological [[hunting-hypothesis]]. **[[steward-julian-h|Steward]]**
argued food-collecting "does not create a sexual division of labor, for it is carried out by
both sexes in the same way"; the division arises specifically from **large-game hunting**
requiring sustained male absence, and the resulting family is "based on cultural
complementarity rather than on some inherent or 'natural' tendency" — and so "may be
weakened." Watanabe added that psychological/physiological sex differences "alone would not be
sufficient to explain this division." The strong-biological reading is attributed and
contested; that women's gathering supplied the dietary base is a convergent finding across
foraging cases.
