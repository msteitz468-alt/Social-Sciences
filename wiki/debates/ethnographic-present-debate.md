---
title: "The Ethnographic Present: Convention or Denial of Coevalness?"
...
# The Ethnographic Present: Convention or Denial of Coevalness?

At issue is the anthropological convention of describing a studied society in the timeless present tense — "The X are matrilineal." Is this a harmless, even useful, writing convention, or a symptom of a deeper failure to treat the people studied as contemporaries? The dispute is methodological and ethical at once, and it is a compact instance of the wider quarrel over anthropology's temporal and colonial assumptions that defined the discipline's critical turn. See the concept page [[ethnographic-present]].

## Position 1 — A legitimate convention

On this view the present tense is a **stylistic default** with defensible uses: it avoids the repetitive hedging that dating and quantifying every sentence would require, and — more substantively — it can express **structural regularities** or enduring institutional forms rather than any claim that a people is timeless or unchanging. Describing a kinship system, an exchange cycle, or a ritual calendar "in the present" states how the system works, not that history has stopped. Defenders hold that the ontological reading (present tense = frozen, changeless "primitives") is a misuse of the convention, not its meaning, and that abandoning it wholesale sacrifices analytic economy for a rhetorical scruple.

## Position 2 — An allochronic device (Fabian)
