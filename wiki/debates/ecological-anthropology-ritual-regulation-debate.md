---
title: "Ecological Anthropology and Ritual Regulation Debate (Rappaport and Critics)"
dispute_type: theoretical
disciplines: [anthropology]
era: [postwar-expansion, critical-turn, contemporary]
positions:
  - "Rappaport / systems-ecology: Tsembaga ritual cycle regulates material relations (pigs, gardens, warfare, exchange) as homeostat and transducer; cognized and operational models both required; ecological rationality ≠ economic rationality"
  - "Functionalist/teleology critique (Friedman and others): regulatory thesis is teleological or circular; negative-feedback formulations can be logically misused; 'whatever happens maintains the system'"
...
# Ecological Anthropology and Ritual Regulation Debate
...
**Strongest form (McArthur line and allies):** Measurements of diet, protein, and pig slaughter do not support key adaptive nutritional payoffs; the kaiko is better read as prestige, waste, or mis-specified "stress feast"; methods and standards are disputed. Rappaport's App. 11 cites Buchbinder/Wood protein recalculations, PCM rates, and reconstructed stress-related kills; he **downgrades** the relative weight of nutritional emphasis versus the 1968 book while disputing McArthur's reading of his argument.

## Position 4 — Meaning-first / anti-reduction

**Strongest form (Sahlins practical-reason currents and interpretive allies):** Treating spirits, sacrifice, and festival primarily as ecological controls reduces culture to feedback loops and misses what ritual is *about* for participants. Sahlins's critique of practical reason / ecological fetishism (as Rappaport reconstructs it) holds that law-like ecological explanation and cultural meaning are crossed explicanda. Rappaport answers that dual models and "logos" of systems need not collapse into economism, and that cognized models can be evaluated for adaptive consequences without equating them to operational models.

## Position 5 — Units, isolation, and social factors

**Strongest form (Ellen, Bennett, and others):** Ecosystem and regional-system boundaries are analytic choices that can smuggle closed-system assumptions; social, political, and individual agency (including big-man politics and colonial context) are underplayed relative to feedback diagrams. Rappaport replies with open, articulated subsystems, interlevel contradiction, and later maladaptation taxonomies — still disputed.

## Curator's note

*(None — open multiparty dispute; do not adjudicate in wiki voice. Study page `replication_status: reanalyzed-contested`.)*
